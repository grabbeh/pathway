import { SectionTitle, Subtitle, Tagline, IntroTitle, BodyText, Text } from '../components/typography'
import { Header, Footer, FindOutMore, FullButton } from '../components/shared'
import { Box, Flex,StandardSection as Section } from '../components/general'
import Colors from '../design-system/Colors'
import FontSizes from '../design-system/FontSizes'
import FontWeights from '../design-system/FontWeights'
import DesignSystemWrapper from '../design-system/DesignSystemWrapper'
...
import HomelessnessQuote from '../components/homelessness/Quote'
import SupportPackageQuote from '../components/online-manual/Quote'
...
Here's the theme object used in the site:
...
<Tagline text='Tagline' color='blue' />
...
Quote sections call out quotes from people who have benefitted from Pathway services. The Quote component takes the variant prop which can be used in Contentful to define specific color schemes defined in the theme object.
...
```
<HomeQuote variant='light' />
<HomelessnessQuote variant='blue' />
<SupportPackageQuote variant='green' />
```
